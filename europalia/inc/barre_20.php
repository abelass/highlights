...
define('_DIR_EUROPALIA_IMG', _DIR_PLUGIN_EUROPALIA.'/img_pack/icones_barre/');
...
function afficher_formatages_speciaux($champ, $spip_lang, $champhelp, $num_barre) {
	...
	$reta .= bouton_barre_racc("barre_raccourci('\n\n&lt;span class=\'rouge\'&gt;','&lt;/span&gt;\n\n',$champ, $num_barre)", _DIR_EUROPALIA_IMG.'rouge.jpg', _T('europalia:barre_rouge'), $champhelp);
	$reta .= bouton_barre_racc("barre_raccourci('\n\n&lt;span class=\'vert\'&gt;','&lt;/span&gt;\n\n',$champ, $num_barre)", _DIR_EUROPALIA_IMG.'vert.jpg', _T('europalia:barre_vert'), $champhelp);
	$reta .= bouton_barre_racc("barre_raccourci('\n\n&lt;span class=\'bleu\'&gt;','&lt;/span&gt;\n\n',$champ, $num_barre)", _DIR_EUROPALIA_IMG.'bleu.jpg', _T('europalia:barre_bleu'), $champhelp);
	$reta .= bouton_barre_racc("barre_raccourci('\n\n&lt;span class=\'gray\'&gt;','&lt;/span&gt;\n\n',$champ, $num_barre)", _DIR_EUROPALIA_IMG.'gray.jpg', _T('europalia:barre_gray'), $champhelp);
	$reta .= bouton_barre_racc("barre_raccourci('\n\n&lt;span class=\'lightgray\'&gt;','&lt;/span&gt;\n\n',$champ, $num_barre)", _DIR_EUROPALIA_IMG.'lightgray.jpg', _T('europalia:barre_lightgray'), $champhelp);
	$tableau_formulaire = '
	<table class="spip_barre" style="width: auto; padding: 1px!important; border-top: 0px;" summary="">
	  <tr class="spip_barre">
