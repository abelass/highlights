...
function contenu_naviguer($id_rubrique, $id_parent) {
  ...
  $res .= afficher_objets('article',_T('info_tous_articles_en_redaction'), array("WHERE" => "statut='prepa' AND id_rubrique=$id_rubrique", 'ORDER BY' => "0+titre,titre,date DESC"));


	//////////  Les articles publies
	/////////////////////////

	define('_TRI_ARTICLES_RUBRIQUE', '0+titre,titre,date DESC');  # 0+titre,titre
